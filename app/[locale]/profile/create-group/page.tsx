              ...
              {["ANY", "MALE", "FEMALE", "OTHER"].map((g) => (
                ...
                >
                  <input
                    ...
                    onChange={(e) => {
                      e.target.parentElement?.setAttribute("data-checked", "true");
                    }}
                  />
                  <span className="text-[11px] font-semibold tracking-wide">{t(g)}</span>
                </label>
              ))}
            </div>
          </div>
        ...
        <div className="bg-[#121212] rounded-[2rem] p-6 space-y-8 shadow-[0_0_20px_rgba(0,0,0,0.4)]">
          ...
          <div className="flex justify-between items-center bg-black/20 p-4 rounded-2xl border border-white/5">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" name="publicProfile" className="sr-only peer" defaultChecked />
              <div className="w-10 h-5 bg-gray-700 rounded-full peer-checked:bg-[#FF725E] 

    ...
    <div className="min-h-screen bg-black text-white font-sans pb-32">
      ...
      <div className="mt-8 px-6">
        ...
        <div className="bg-[#111111] rounded-[2.5rem] p-8 shadow-xl border border-white/5 flex flex-col items-center text-center">
          ...
          <button className="w-full bg-[#FF5733] text-white font-extrabold py-4 rounded-2xl shadow-[0_4px_20px_rgba(255,87,51,0.4)] hover:bg-[#e64d2e] active:scale-95 transition-all">
            {t('createGroupButton')}
          </button>
        </div>
      </div>
